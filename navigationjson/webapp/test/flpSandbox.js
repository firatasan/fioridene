		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#navigationjson-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"navigationjson-display": {
								"semanticObject": "navigationjson",
								"action": "display",
								"description": "Navigation JSON Calismasi",
								"title": "Navigation JSON",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=navigationjson",
									"url": sap.ui.require.toUrl("navigationjson")
								}
							}
						}
					}

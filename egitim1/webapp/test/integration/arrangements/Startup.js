sap.ui.define([
	"sap/ui/test/Opa5",
	"com/nuwency/egitim1/egitim1/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.nuwency.egitim1.egitim1.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.nuwency.egitim1.egitim1",
					async: true
				},
				hash: oOptions.hash,

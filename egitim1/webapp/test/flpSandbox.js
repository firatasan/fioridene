		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Egitim 1 Uygulamasi",
									"targetURL": "#comnuwencyegitim1egitim1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnuwencyegitim1egitim1-display": {
								"semanticObject": "comnuwencyegitim1egitim1",
								"action": "display",
								"description": "Egitim 1 Uygulamasi Descriptionu",
								"title": "Egitim 1 Uygulamasi",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.nuwency.egitim1.egitim1",
									"url": sap.ui.require.toUrl("com/nuwency/egitim1/egitim1")
								}
							}
						}
					}
